...
export const HeroSection = () => {
    return (
        ...
        >
            <div className="container max-w-4xl mx-auto text-center z-10">
                <div className="space-y-6">
                    <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
                        ...
                        <span className="text-primary opacity-0 animate-fade-in-delay-1"> {" "} Ana Clara </span>
            ...
            <div
                className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center amimate-bounce">
